...
- **Deep Linking**: SideQuest now automatically re-focuses when you complete login in your browser.
...
- Resolved a bug where the streak count would reset prematurely for some timezones.
- Patched a vulnerability where network interception could bypass feature gates.
